...
contract DSCEngine is ReentrancyGuard {
     ...
     */
    function reddemCollateralForDsc(address tokenCollateralAddress, uint256 amountCollateral, uint256 amountDscToBurn) external {
     ...
     * @notice You will get a liquidation banus for taking the users funds.
